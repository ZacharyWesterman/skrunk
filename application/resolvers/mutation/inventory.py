...
@perms.require(['edit'])
def resolve_create_inventory_item(_, info, category: str, type: str, location: str, blob_id: str, description: str, rfid: str) -> dict:
	...
	try:
		return { '__typename': 'Item', **create_inventory_item(category, type, location, blob_id, description, rfid) }
