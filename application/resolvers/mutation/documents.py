...
from application.db.documents import create_document, update_document, delete_document
...
def resolve_create_document(_, info: GraphQLResolveInfo, title: str, body: str, parent: str | None) -> dict:
	"""
...
@perms.module('documents')
@handle_client_exceptions
def resolve_update_document(_, info: GraphQLResolveInfo, id: str, title: str | None, body: str | None, parent: str | None) -> dict:
	"""
...
@perms.module('documents')
@handle_client_exceptions
def resolve_delete_document(_, info: GraphQLResolveInfo, id: str) -> dict:
	"""
