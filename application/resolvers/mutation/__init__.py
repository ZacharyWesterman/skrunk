...
mutation.set_field('updateUsername', resolve_update_username)
...
mutation.set_field('sendNotificationAsRead', resolve_send_notification_as_read)
...
mutation.set_field('createFeedDocument', resolve_create_feed_document)
mutation.set_field('updateFeedDocument', resolve_update_feed_document)
mutation.set_field('markDocumentRead', resolve_mark_document_read)
mutation.set_field('setFeedInactive', resolve_set_feed_inactive)
mutation.set_field('setFeedNavigation', resolve_set_feed_navigation)
